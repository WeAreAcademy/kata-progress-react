import { Table, TableCaption, TableContainer, Tbody, Td, Th, Thead, Tooltip, Tr, VStack } from "@chakra-ui/react";
...
export function AllKatasWithCompletersView(props: AllKatasWithCompletersViewProps) {
    ...
    useEffect(() => {
        async function fetchAndStoreKatasWithAllCompleters() {
            ...
            const response = await axios.get(apiBaseURL + "/katas/all_users", { headers });
    ...
    return (
        <TableContainer>
            <Table >
                <TableCaption>All katas and who has completed them</TableCaption>
                <Thead>
                    <Tr>
                        <Th>Kata Title</Th>
                        <Th>Difficulty</Th>
